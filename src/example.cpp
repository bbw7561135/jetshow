...
// Compile with:
// c++ -O3 -Wall -shared -std=c++14 -lCGAL -L/usr/lib/openmpi -lmpi_cxx -fopenmp -fPIC `python3 -m pybind11 --includes` -o example.so src/example.cpp src/BField.cpp src/Cone.cpp src/Geometry.cpp src/Ray.cpp src/Intersection.cpp src/Cell.cpp src/Pixel.cpp src/Image.cpp src/ImagePlane.cpp src/NField.cpp src/VField.cpp src/Jet.cpp src/Cylinder.cpp src/utils.cpp src/System.cpp src/Observation.cpp src/SimulationInterpolater.cpp -I/home/ilya/github/jetshow/include  -I/usr/include/eigen3
PYBIND11_MODULE(example, m) {
    ...
    m.def("run_analytical_params", &run_analytical_params, "Run BK", "los_angle"_a, "redshift"_a,
